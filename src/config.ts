...
export function mergeConfig(userConfig: Partial<HudConfig>): HudConfig {
  ...
  const display = {
    ...
    showPluginCount: typeof migrated.display?.showPluginCount === 'boolean'
      ? migrated.display.showPluginCount
      : DEFAULT_CONFIG.display.showPluginCount,
    showSkillCount: typeof migrated.display?.showSkillCount === 'boolean'
      ? migrated.display.showSkillCount
      : DEFAULT_CONFIG.display.showSkillCount,
