...
# Configure Claude HUD（CC Switch 适配版）

**FIRST**: Use the Read tool to load `~/.claude/plugins/claude-hud-ccswitch/config.json` if it exists.
...
Write to `~/.claude/plugins/claude-hud-ccswitch/config.json`.
